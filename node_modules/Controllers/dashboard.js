...
function DisplayLight(){};
	...
	DisplayLight.prototype.getParam = function(){
		if(this.param1 == true) return { alwaysOn:true };
		if(this.param2 == true) return { sec20:true };
		if(this.param3 == true) return { hour1:true };
		return undefined;
	};
...
function HeatingSystem(){};
	...
	HeatingSystem.prototype.setParam = function(param){
		if(this.param1 == true)
		{
			this.param1 = false;
