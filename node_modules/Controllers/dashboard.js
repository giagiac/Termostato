...
function Vector(){};
	...
	Vector.prototype.setParam1 = function(param1){
		throw new Error("param1 set is not defined");
	};
	Vector.prototype.setParam2 = function(param2){
		throw new Error("param2 set is not defined");
	};
	Vector.prototype.setParam3 = function(param3){
		throw new Error("param3 set is not defined");
	};
	Vector.prototype.setParam4 = function(param4){
		throw new Error("param4 set is not defined");
	};
...
function DisplayLight(){};
	...
	DisplayLight.prototype.setParam = function(param){
		...
		throw new Error("set paramaters error -> " + param);		
	};
	DisplayLight.prototype.getParam = function(){
		var value = undefined;
		if(this.param1 == true) value = { alwaysOn:true }; //mantengo per retrocompatibilità - non servono perchè sost da fileWriter.read
		if(this.param2 == true) value = { sec20:true };
		if(this.param3 == true) value = { hour1:true };
